                                        ...
                                        <div id="qoutescarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                            ...
                                            <div class="carousel-inner text-center text-white-50 pb-5 carousel-text-shadow">
                                                <div class="carousel-item active">
                                                    <p class="fs-15 fst-italic">" Chào mừng bạn đến với trang quản trị Eco
                                                        Furnish "</p>
                                                </div>
                                                <div class="carousel-item">
                                                    <p class="fs-15 fst-italic">" Eco Furnish - Nơi mang đến những sản phẩm
                                                        nội thất thân thiện với môi trường và thiết kế hiện đại cho không
                                                        gian sống của bạn "</p>
                                                </div>
                                                <div class="carousel-item">
                                                    <p class="fs-15 fst-italic">" Chúc bạn có một ngày làm việc hiệu quả và
                                                        thành công "</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="mt-4" data-aos="fade-up" data-aos-delay="300">
                                    <form action="{{ route('admin.login.post') }}" method="POST" id="loginForm">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <div>
                                                <a href="{{ route('admin.password.request') }}" class="text-primary">Quên
                                                    mật khẩu?</a>
                                            </div>
                                        </div>
...
@push('scripts')
    ...
    <style>
        ...
        /* Style cho nút hiển thị mật khẩu */
        .password-addon {
