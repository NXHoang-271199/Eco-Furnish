              ...
              <DropdownMenuTrigger asChild>
                ...
                >
                  ...
                  <ChevronDown
                    size={16}
                    strokeWidth={2}
                    className={`ms-1 opacity-60 transition-transform group-data-[state=open]:rotate-180`}
                    aria-hidden="true"
                  />
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent
                className="w-[520px] mt-2 border-0 shadow-xl rounded-xl bg-white overflow-hidden"
                align="start"
                sideOffset={8}
              >
                  ...
                  {Object.keys(categoriesBySpace).length > 0 ? (
                    Object.keys(categoriesBySpace).map((spaceName) => (
                      <DropdownMenuItem
                        ...
                        className="cursor-pointer hover:bg-green-50 p-3 text-sm transition-all duration-200 rounded-lg flex flex-col items-start h-auto focus:bg-green-50"
                      >
                    ...
                    <DropdownMenuItem disabled className="px-3 py-3 text-sm text-gray-500 col-span-3">
