...
<div class="form-container">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 text-primary">Chỉnh sửa sản phẩm</h4>
    ...
    <form id="productForm" action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="switch-container">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="variantToggle" {{ count($product->variants) > 0 ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        <div class="form-group mb-4">
                            ...
                            @if($product->image_thumnail)
                                <div id="thumbnailPreview" class="mt-2 main-image-preview">
            ...
            <!-- Phần biến thể -->
            <div class="col-12">
                <div class="card variant-section" id="variantSection" {{ count($product->variants) > 0 ? 'style=display:block' : '' }}>
                    <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        <div id="variants-container">
                            <!-- Các biến thể đã thêm sẽ được hiển thị ở đây -->
                        </div>
                    </div>
                </div>
            </div>
