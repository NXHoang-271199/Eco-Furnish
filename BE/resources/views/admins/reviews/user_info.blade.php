                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    <p><strong><i class="fas fa-star mr-2"></i> Tổng số đánh giá:</strong> <span class="badge bg-primary">{{ $reviewCount }}</span></p>
                                    <p><strong><i class="fas fa-boxes mr-2"></i> Tổng số đơn hàng:</strong> <span class="badge bg-primary">{{ $orderCount }}</span></p>
