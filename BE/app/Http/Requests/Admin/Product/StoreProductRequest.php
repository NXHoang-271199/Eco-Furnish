...
class StoreProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'image_thumnail' => 'required|image|mimes:jpeg,png,jpg,gif|max:2048',
            'gallery.*' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2048',
            'variants' => 'array|nullable',
            'variants.*.sku' => 'required_with:variants|string|max:50|distinct|unique:product_variants,sku,NULL,id,deleted_at,NULL',
            'variants.*.price' => 'required_with:variants|numeric|min:0',
            'variants.*.values' => 'required_with:variants|array',
            'variants.*.values.*' => 'required|exists:variant_values,id'
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'variants.*.values.*.required' => 'Vui lòng chọn giá trị cho tất cả các biến thể',
