            ...
            0 < e.querySelectorAll(".notification-item").length
                ...
                : (e.querySelector(".view-all") &&
                  ...
                  e.querySelector(".empty-notification-elem") ||
                      (e.innerHTML +=
                          '<div class="empty-notification-elem">\t\t\t\t\t\t\t<div class="w-25 w-sm-50 pt-3 mx-auto">\t\t\t\t\t\t\t\t<img src="/assets/admins/images/svg/bell.svg" class="img-fluid" alt="user-pic">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="text-center pb-5 mt-2">\t\t\t\t\t\t\t\t<h6 class="fs-18 fw-semibold lh-base">Hey! You have no any notifications </h6>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>'));
        });
    }
    function P() {
        var e;
            ...
            Array.from(
                ...
                t.addEventListener("change", function (e) {
                    ...
                    e.target
                        ...
                        document.getElementById("select-content") &&
                            (document.getElementById(
                                "select-content"
                            ).innerHTML = t);
                }),
